  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center px-4 py-8 relative z-10">
        <h1 className="text-6xl text-main my-8 font-normal text-center"
        ...
        <div className="flex flex-col gap-6 w-full max-w-[500px]">
          {cards.map((card) => (
            <div
              key={card.id}
              className={`${card.bgColor} rounded-[20px] p-12 flex justify-between items-center cursor-pointer transition-transform duration-300 ease-out relative overflow-hidden`}
              style={{
            ...
            >
              ...
              <h2 className="text-4xl text-main m-0 font-normal relative z-10"
                style={{ fontFamily: "var(--font-heading)" }}>
                {card.title}
              </h2>
