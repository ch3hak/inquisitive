...
const QuizPage = () => {
        ...
        <div className="max-w-md mx-auto px-4 py-8">
          <div className="text-center mb-12">
            ...
            <input
              ...
              className="w-full bg-transparent text-white text-center text-5xl uppercase mb-6 outline-none"
            ...
            {questionsEdit.map((q, index) => (
              ...
              >
                <div className="h-full p-4 flex items-center justify-between gap-3">
                  ...
                  <div className="flex-1" onClick={() => setEditQuestionIndex(index)}>
                  ...
                  <button
                    onClick={() => setEditQuestionIndex(index)}
          ...
          <button
            ...
            className="w-full mt-4 rounded-3xl p-4 transition-all"
      ...
      <div className="min-h-screen flex flex-col" style={{ background: 'var(--color-create)' }}>
        ...
        <div className="px-6 pb-6" style={{ background: 'var(--color-background)' }}>
          ...
          <div className="flex items-center justify-between pt-4">
            ...
            <button
              onClick={() => setEditQuestionIndex(null)}
            >
  ...
  if (userResponse && !isOwner && currentQuestionIndex !== null) {
    ...
    return (
      <div className="min-h-screen flex flex-col" style={{ background: isWrong ? 'var(--color-bg-wrong)' : 'var(--color-join)' }}>
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
          <div className="w-full max-w-md space-y-8">
            <div className="text-center" style={{ color: isWrong ? 'var(--color-text-wrong)' : 'white' }}>
              <h2 className="text-4xl mb-6" style={{ fontFamily: 'var(--font-heading)' }}>
          ...
          <div className="w-full max-w-md mx-auto space-y-3 pt-5 pb-5">
            {q.options.map((opt, optIdx) => {
              ...
              return (
                <div
                  key={optIdx}
                  className="w-full py-5 px-6 rounded-3xl text-center text-base dm-sans-regular"
                  style={{
                    background: optionBg,
                    color: optionText
                  }}
              ...
              return (
                <div
                  ...
                  style={{
                    background: isCorrect
                      ? (hoveredQuestionIndex === index ? 'var(--color-join-highlight)' : 'var(--color-join)')
                      : (hoveredQuestionIndex === index ? 'var(--color-bg-wrong)' : 'var(--color-bg-wrong)'),
                ...
                >
                  <div className="h-full p-5 flex items-center justify-between gap-3" style={{
                    ...
                    <button className="w-10 h-10 rounded-full border-2 flex items-center justify-center transition-transform duration-300" style={{
      ...
      <div className="max-w-md mx-auto">
        ...
        {isOwner && (
          <div className="mb-8 space-y-4">
            <div 
              className="rounded-3xl p-6 flex items-center justify-between cursor-pointer transition-all"
              style={{ 
                background: !quizMeta.acceptingResponses 
                  ? 'var(--color-bg-wrong)' 
                  : 'var(--color-bg-wrong)',
                height: hoveredOwnerCard === 'toggle' ? '180px' : '120px',
                transform: hoveredOwnerCard === 'toggle' ? 'scale(1.02)' : 'scale(1)'
              }}
              onMouseEnter={() => setHoveredOwnerCard('toggle')}
              onMouseLeave={() => setHoveredOwnerCard(null)}
            ...
            <div 
              ...
              style={{ 
                background: '#06034C',
                height: hoveredOwnerCard === 'edit' ? '140px' : '100px',
                transform: hoveredOwnerCard === 'edit' ? 'scale(1.02)' : 'scale(1)'
              }}
              onMouseEnter={() => setHoveredOwnerCard('edit')}
              onMouseLeave={() => setHoveredOwnerCard(null)}
              onClick={handleEdit}
            >
              ...
              <div className="w-14 h-14 rounded-full border-2 border-white flex items-center justify-center transition-transform duration-300" style={{
                transform: hoveredOwnerCard === 'edit' ? 'rotate(-90deg)' : 'rotate(0deg)'
              }}>
            ...
            <div 
              ...
              style={{ 
                background: '#06034C',
                height: hoveredOwnerCard === 'responses' ? '140px' : '100px',
                transform: hoveredOwnerCard === 'responses' ? 'scale(1.02)' : 'scale(1)'
              }}
              onMouseEnter={() => setHoveredOwnerCard('responses')}
              onMouseLeave={() => setHoveredOwnerCard(null)}
            ...
            >
              ...
              <div className="w-14 h-14 rounded-full border-2 border-white flex items-center justify-center transition-transform duration-300" style={{
                transform: hoveredOwnerCard === 'responses' ? 'rotate(-90deg)' : 'rotate(0deg)'
              }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5">
                  <path d="M5 12h14M12 5l7 7-7 7"/>
                </svg>
            ...
            <div 
              ...
              style={{ 
                ...
                height: hoveredOwnerCard === 'delete' ? '140px' : '100px',
                transform: hoveredOwnerCard === 'delete' ? 'scale(1.02)' : 'scale(1)'
              }}
              onMouseEnter={() => setHoveredOwnerCard('delete')}
              onMouseLeave={() => setHoveredOwnerCard(null)}
            ...
            >
              ...
              <div className="w-14 h-14 rounded-full border-2 flex items-center justify-center transition-transform duration-300" style={{
                borderColor: 'var(--color-text-wrong)',
                transform: hoveredOwnerCard === 'delete' ? 'rotate(-90deg)' : 'rotate(0deg)'
              }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--color-text-wrong)" strokeWidth="2.5">
                  <path d="M5 12h14M12 5l7 7-7 7"/>
                </svg>
              </div>
            </div>
